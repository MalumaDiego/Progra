  ...
  <table class="table">
    ...
    <tbody>
       <logic:iterate id="tabla" indexId="index" name="nn" property="tabla">
         <tr>
          <td><bean:write name="tabla" property="idju" /></td>
          <td><bean:write name="tabla" property="nombre" /></td>
          <td><bean:write name="tabla" property="app" /></td>
          <td><bean:write name="tabla" property="apm" /></td>
          <td><bean:write name="tabla" property="tj" /></td>
          <td><bean:write name="tabla" property="tg" /></td>
      </tr>
    </logic:iterate>
    </tbody>
  </table>
